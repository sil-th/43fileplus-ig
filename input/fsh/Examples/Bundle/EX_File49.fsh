Instance: bundle-file49-document
InstanceOf: Bundle
Title: "ตัวอย่าง Bundle - แฟ้มที่ 49: REFER_HISTORY"
Description: "ข้อมูลประวัติการส่งต่อผู้ป่วย (ทั้งกรณีส่งออก และรับเข้า) ประกอบด้วย Patient, Encounter, QuestionnaireResponse และ Appointment resource"
Usage: #example
...
* entry[0]
  * fullUrl = "http://example.org/Composition/composition-file-49"
  * resource = composition-file-49
* entry[+]
...
Instance: composition-file-49
InstanceOf: Composition
Title: "ตัวอย่าง Composition แฟ้มที่ 49: REFER_HISTORY"
Description: "Composition ของแฟ้มที่ 49"
Usage: #example
* status = #final
* type
  * coding[0] = $LNC#75619-7 "National Health Care Surveys report"
  * coding[+] = $CS_THCC_43fileType#49 "REFER_HISTORY"
* subject = Reference(Patient/patient-patient4) "นาง สมควร ใจดี"
* date = "2022-07-29T12:30:02+07:00"
* author[0] = Reference(Organization/organization-main)
  * insert GeneralReference($ID_Hcode, "XXXXX", "โรงพยาบาลตัวอย่าง")
* title = "แฟ้มที่ 49 REFER_HISTORY: ข้อมูลประวัติการส่งต่อผู้ป่วย (ทั้งกรณีส่งออก และรับเข้า)"
* section[0]
