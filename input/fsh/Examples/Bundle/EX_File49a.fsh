Instance: bundle-file49a-document
InstanceOf: Bundle
Title: "ตัวอย่าง Bundle - แฟ้มที่ 49a: REFER_HISTORY"
Description: "ข้อมูลประวัติการส่งต่อผู้ป่วย (กรณีส่งออก) ประกอบด้วย Patient, Encounter, Condition, ServiceRequest, QuestionnaireResponse, Organization, Account และ Coverage resource"
Usage: #example
...
* entry[0]
  * fullUrl = "http://example.org/Composition/composition-file-49a"
  * resource = composition-file-49a
* entry[+]
...
Instance: composition-file-49a
InstanceOf: Composition
Title: "ตัวอย่าง Composition แฟ้มที่ 49a: REFER_HISTORY"
Description: "Composition ของแฟ้มที่ 49a"
Usage: #example
* status = #final
* type
...
* title = "แฟ้มที่ 49a REFER_HISTORY: ข้อมูลประวัติการส่งต่อผู้ป่วย (กรณีส่งออก)"
* section[0]
  * title = "ข้อมูลผู้ป่วย"
