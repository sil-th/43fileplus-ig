...
Description: "ข้อมูลประวัติการส่งต่อผู้ป่วย (ทั้งกรณีส่งออก) ประกอบด้วย Patient, Encounter, QuestionnaireResponse และ Appointment resource"
Usage: #example
...
* title = "แฟ้มที่ 49a REFER_HISTORY: ข้อมูลประวัติการส่งต่อผู้ป่วย (ทั้งกรณีส่งออก)"
* section[0]
