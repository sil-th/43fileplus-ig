...
Description: "ข้อมูลวินิจฉัยโรคของผู้ป่วยที่ได้รับการส่งต่อ (ทั้งกรณีส่งออก และรับเข้า) ประกอบด้วย Patient, Encounter, QuestionnaireResponse และ Appointment resource"
Usage: #example
...
* type
  ...
  * coding[+] = $CS_THCC_43fileType#53 "DIAGNOSIS_REFER"
