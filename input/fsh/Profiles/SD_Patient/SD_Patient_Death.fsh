Profile: Moph43pPatientDeath
Parent: Patient
Id: moph43p-patient-death
Title: "MoPH43p Patient: Death"
Description: "ข้อมูลทั่วไปของประชาชนในเขตรับผิดชอบ และผู้ที่มาใช้บริการ ซึ่งเสียชีวิตแล้ว"
* ^url = $SD_Patient_Death
* ^status = #draft
