...
Alias: $CS_THCC_AllergyCertainy = http://terms.sil-th.org/CodeSystem/cs-thcc-allergy-certainty
...
Alias: $QN_TH_Village = https://fhir-ig.sil-th.org/43filesplus/Questionnaire/TH-village
Alias: $QN_TH_Dental = https://fhir-ig.sil-th.org/43filesplus/Questionnaire/TH-dental